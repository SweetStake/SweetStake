...
unsigned int nStakeMaxAge = 256 * 24 * 60 * 60;
...
const string strMessageMagic = "SweetStake Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SweetStake", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "zaterdag 19 september 2015 ecbde127-9b83-4bae-befc-ff9c2eaa6d99";
        CTransaction txNew;
        txNew.nTime = 1442681399;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("0x3eaeca77af545762557543989089c217e2b39d68837ec81401b83299c55d5854");
